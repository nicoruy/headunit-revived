...
class AudioDecoder {
    ...
    fun start(channel: Int, stream: Int, sampleRate: Int, numberOfBits: Int, numberOfChannels: Int, isAac: Boolean = false) {
        val thread = AudioTrackWrapper(stream, sampleRate, numberOfBits, numberOfChannels, isAac)
